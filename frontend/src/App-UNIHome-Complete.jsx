      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <input
            ...
            placeholder="Es: Stanza singola vicino università"
            required
          />
        </div>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <textarea
            ...
            placeholder="Descrivi la tua casa/stanza..."
            required
          />
        </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gap: '20px' }}>
          ...
          <div style={{
            ...
            <h3 style={{ marginBottom: '10px' }}>📱 Telefono</h3>
            <p>{user?.telefono || 'Non specificato'}</p>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ marginBottom: '10px' }}>🎂 Anno di Nascita</h3>
            <p>{user?.anno_nascita || 'Non specificato'}</p>
          </div>
        </div>
      </div>
    </div>
...
// App principale con routing completo
export default function UNIHomeApp() {
  console.log("🏠 UNI Home - App Completa Avviata");
